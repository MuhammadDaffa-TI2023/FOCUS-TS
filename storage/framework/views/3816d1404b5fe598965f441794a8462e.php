                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="<?php echo e(route('add-materi-mentor')); ?>" method="post" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="modal fade " id="editdokumen<?php echo e($m->id); ?>">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content bg-white">
                                            ...
                                            <div class="modal-body">
                                                <form action="<?php echo e(route('edit-materi-mentor', $m->id)); ?>" method="post"
                                    ...
                                    <div class="modal fade" id="deletedokumen<?php echo e($m->id); ?>">
                                        <div class="modal-dialog">
                                            <div class="modal-content bg-white">
                                                ...
                                                <form action="<?php echo e(route('delete-materi-mentor', $m->id)); ?>" method="post">
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('role.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KERJAAN\joki-rpl\focus-ta\resources\views/role/mentor/materi.blade.php ENDPATH**/ ?>