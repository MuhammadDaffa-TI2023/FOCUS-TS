    ...
    <div class="row">
        ...
        <div class="col-md-12 mb-30">
            <div class="box bg-white shadow ">
                <div class="box-head">
                    <h4 class="title text-secondary">Daftar Prodi</h4>
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                        data-bs-target="#tambahprodi">Tambah</button>
                    
                    <div class="modal fade " id="tambahprodi">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content bg-white">
                                <div class="modal-header">
                                    <h5 class="modal-title text-secondary">Tambah Prodi</h5>
                                    <button class="close" data-bs-dismiss="modal"><span
                                            aria-hidden="true">&times;</span></button>
                                </div>
                                <div class="modal-body">
                                    <form action="<?php echo e(route('add-prodi')); ?>" method="post">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('post'); ?>
                                        <div class="row mbn-15 mt-2">
                                            <div class="col-12 mb-15">
                                                <label for="" class="text-secondary">Nama</label>
                                                <input type="text" class="form-control bg-secondary text-white" name="nama" placeholder="Nama Prodi" required>
                                            </div>
                                        </div>
                                </div>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $prodi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="text-white">
                                        ...
                                        <td class="text-secondary"><?php echo e($p->nama); ?></td>
                                        <td>
                                            <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                                                data-bs-target="#editprodi<?php echo e($p->id); ?>">Edit</button>
                                            
                                            <div class="modal fade " id="editprodi<?php echo e($p->id); ?>">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content bg-white">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title text-secondary">Edit Prodi</h5>
                                                            <button class="close" data-bs-dismiss="modal"><span
                                                                    aria-hidden="true">&times;</span></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <form action="<?php echo e(route('edit-prodi', $p->id)); ?>" method="post">
                                                                <?php echo csrf_field(); ?>
                                                                ...
                                                                <div class="row mbn-15 mt-2">
                                                                    <div class="col-12 mb-15">
                                                                        ...
                                                                        <input type="text"
                                                                            ...
                                                                            name="nama" placeholder="Nama Prodi" required
                                                                            value="<?php echo e(old('nama', $p->nama)); ?>">
                                                                    </div>
                                                                </div>
                                                        </div>
                                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="button button-danger" data-bs-toggle="modal"
                                                data-bs-target="#deleteprodi<?php echo e($p->id); ?>">Hapus</button>
                                            
                                    <div class="modal fade" id="deleteprodi<?php echo e($p->id); ?>">
                                        <div class="modal-dialog">
                                           <div class="modal-content bg-white ">
                                             <div class="modal-header">
                                              ...
                                              <form action="<?php echo e(route('delete-prodi', $p->id)); ?>" method="post">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\FOCUS TA\focus-ta\resources\views/prodi/index.blade.php ENDPATH**/ ?>