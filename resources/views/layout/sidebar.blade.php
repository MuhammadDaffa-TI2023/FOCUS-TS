<div class="">
    <nav class="side-header-menu" id="side-header-menu">
        <ul>
            <li><a class="text-white" href="{{ route('dashboard-admin') }}">Dashboard</a></li>
            <li><a class="text-white" href="{{ route('dashboard-prodi') }}">Prodi</a></li>
            <li><a class="text-white" href="{{ route('dashboard-kategori') }}">Kategori</a></li>
            <li><a class="text-white" href="{{ route('dashboard-fakultas') }}">Fakultas</a></li>
            ...
            <li><a class="text-white" href="{{ route('dashboard-materi') }}">Materi</a></li>
