                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('add-materi-mentor') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('post')
                                ...
                                <div class="modal fade " id="editdokumen{{ $m->id }}">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content bg-white">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('edit-materi-mentor', $m->id) }}" method="post"
                                    ...
                                    <div class="modal fade" id="deletedokumen{{ $m->id }}">
                                        <div class="modal-dialog">
                                            <div class="modal-content bg-white">
                                                ...
                                                <form action="{{ route('delete-materi-mentor', $m->id) }}" method="post">
                                                    @csrf
                                                    @method('delete')
                                                    <div class="modal-footer">
